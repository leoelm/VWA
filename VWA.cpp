...
}while(sim_count_2<10);
std::cout << MUN_relchance << '\n';
std::cout << ALBA_relchance << '\n';
std::cout << LUD_relchance << '\n';
std::cout << BAYR_relchance << '\n';
std::cout << BONN_relchance << '\n';
std::cout << EWE_relchance << '\n';
std::cout << BRO_relchance << '\n';
std::cout << SKY_relchance << '\n';
std::cout << ULM_relchance << '\n';
std::cout << SOL_relchance << '\n';
std::cout << GIE_relchance << '\n';
std::cout << BRA_relchance << '\n';
std::cout << JENA_relchance << '\n';
std::cout << MITT_relchance << '\n';
std::cout << GOTT_relchance << '\n';
std::cout << BRE_relchance << '\n';
std::cout << ROCK_relchance << '\n';
std::cout << TIG_relchance << '\n';
  return 0;
};
