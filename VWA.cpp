...
void simulation_17_18(){
  ...
  float MUN_ranking = 100;
  float ALBA_ranking = 100;
  float LUD_ranking = 100;
  float BAYR_ranking = 100;
  float BONN_ranking = 100;
  float EWE_ranking = 100;
  float BRO_ranking = 100;
  float SKY_ranking = 100;
  float ULM_ranking = 100;
  float SOL_ranking = 100;
  float GIE_ranking = 100;
  float BRA_ranking = 100;
  float JENA_ranking = 100;
  float MITT_ranking = 100;
  float GOTT_ranking = 100;
  float BRE_ranking = 100;
  float ROCK_ranking = 100;
  float TIG_ranking = 100;
    ...
    for(int i = 0; i<54;i++){
      ...
      if(i==0){
        ...
        if(MUN_games>=runde+1){
          ...
          std::cout << "Vector size = " << chance.size() << '\n';
          for(int j = 0;j<chance.size();j++){
            if(chance[j]==decider){
              win++;
            }
